...
\fehr{Maybe something like : MLIR is an extensible compilers that allows users to
define custom IRs...}
...
\fehr{Maybe one sentence on why superoptimization is interesting? i.e. the work
needed to optimize/lower IRs is quite large.}
...
\fehr{Currently, all your points are valid, but you should try to give a bit more of
a narrative. Here, this section feels more like a list of things rather than a
story/motivation.}

\fehr{You need to explain why this is a hard problem. i.e. there are a lot of
instructions with complex semantics.}
...
of a RISC-V \fehr{something missing here}, as well as making use of the infrastructure in the open source project 
...
\fehr{I would probably move refinements either as a subsection to Translation-validation, or after}
Poison.
